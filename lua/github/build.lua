...
M.props = {
  ...
  ["GeekVim"] = {
    spec = '{ "GeekVim/GeekVim", import = "geekvim.plugins" },',
    feature_request = {
      top = [[
  - type: markdown
    attributes:
      value: |
        **IMPORTANT:** ideas or requests related to existing bundles should go in the respective bundle repository.
      ]],
      checks = [[
        - label: This is not a request for an existing bundle
          required: true
      ]],
    },
  },
...
- [ ] I've read the [CONTRIBUTING](https://github.com/GeekVim/GeekVim/blob/main/CONTRIBUTING.md) guidelines.
    ]])
  else
    props.checklist = ""
  end
